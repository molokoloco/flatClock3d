    ...
    var setTouchAware = function (item, eventName, enable) {
        ...
        if (item.ontouchstart !== undefined) {
            switch (eventName.toLowerCase()) {
                case "pointerdown":
                    registerOrUnregisterEvent(item, "touchstart", function(evt) {
                        handleOtherEvent(evt, "pointerenter", true, true);
                        handleOtherEvent(evt, "pointerover", false, true);
                ...
                case "pointermove":
                    ...
                    break;
                case "pointerup":
                    registerOrUnregisterEvent(item, "touchend", function(evt) {
                        handleOtherEvent(evt, eventName);
                        handleOtherEvent(evt, "pointerout", false, true);
                        handleOtherEvent(evt, "pointerleave", false, true);
                    }, enable);
                    break;
                case "pointercancel":
